...
RSpec.describe PlainErrors::Configuration do
  ...
  describe '#initialize' do
    it 'sets default values' do
      ...
      expect(subject.code_lines_context).to eq 2
      ...
      expect(subject.max_stack_trace_lines).to eq 5
    end
  end
  ...
  describe 'attribute accessors' do
    ...
    it 'allows setting and getting max_stack_trace_lines' do
      subject.max_stack_trace_lines = 10
      expect(subject.max_stack_trace_lines).to eq 10
    end
  end
end